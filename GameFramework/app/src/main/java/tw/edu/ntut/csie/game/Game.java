...
public class Game extends Activity {
     ...
     * 定義通用參數
     */
    public static final int directorUp = 0;
    public static final int directorDown = 1;
    public static final int directorLeft = 2;
    public static final int directorRight = 3;
