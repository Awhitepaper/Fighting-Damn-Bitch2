...
public class MonsterSlime extends Monster implements GameObject {
    ...
    private final int _maxHP = 20, _maxMP = 0;
    private int _HP, _MP;
    private final int _EXPvalue = 100;
    private boolean _ExpAdded;


    private static final int _DMG = 100;//攻擊力
    private static final double _HITr = 0.8;//命中率
    private static final double _FLEEr = 0.1;//迴避率
    ...
    //constructor
    public MonsterSlime(GameMap map) {
        _locatedMap = map;
    }
