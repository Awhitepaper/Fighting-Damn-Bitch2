...
public class RedSlime extends Monster implements GameObject {
    ...
    private final int _maxHP = 100, _maxMP = 0;
    public int _HP, _MP;
    private final int _EXPvalue = 200;
    private boolean _ExpAdded;

    private static final int _DMG = 200;//攻擊力
    private static final double _HITr = 0.8;//命中率
    private static final double _FLEEr = 0.3;//迴避率
    private static final double _CRT = 2;//爆擊倍率
    private static final double _CRTr = 0.1;//爆擊機率
    private static final int _DEF = 0;//防禦力

    private boolean _initiative = true; //主動攻擊
    ...
    private static final int _rebornTime = Monster.NON;//NON表示不會重生
    ...
    public void initialize(Hero hero) {
        ...
        _slime_Stand.addFrame(R.drawable.red_slime_stand1);
        _slime_Stand.addFrame(R.drawable.red_slime_stand2);
        _slime_Stand.addFrame(R.drawable.red_slime_stand3);
