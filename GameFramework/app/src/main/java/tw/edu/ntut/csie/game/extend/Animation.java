...
public class Animation implements GameObject {
    ...
    public void show(int Index) {
        ...
        _frames.get(Index).setLocation(_x, _y);
        _frames.get(Index).show();
...
//        _counter = _delay;
     ...
     * 設定播放與否。
     *
     * @param play true表示播放動畫，false表示不播放動畫
     */
    public void setPlay(boolean play) {
        _play = play;
    }

    public boolean checkVisible(){return _visible;}

    /**
     * 確定動畫是否已播'放完畢
     *
     * @return 播放完畢則回傳true 反之則否
     */
    public boolean checkPlayFinished() {
